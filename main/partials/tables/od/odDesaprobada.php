...
$query = "SELECT od.*, 
      ...
      WHERE od.od_estado = 'DESAPROBADA'
...
<?php if ($ordenes_disenio->rowCount() == 0) : ?>
    <div class="col-md-4 mx-auto mb-3 mt-3">
        <div class="card card-body text-center">
            <p>NO HAY ÓRDENES DE DISEÑO DESAPROBADA AÚN.</p>
        </div>
    </div>
<?php else : ?>
        ...
        <tbody>
            <?php foreach ($ordenes_disenio as $orden) : ?>
                <tr>
                    ...
                    <td>
                        <a href="./validaciones/od/odPropuesta.php?id=<?= $orden["od_id"] ?>" class="btn btn-danger mb-2">VOLVER A PROPUESTA</a>
                    </td>
                </tr>
            <?php endforeach ?>
        </tbody>
