            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="row g-3" method="POST" action="registroOd.php">
                        ...
                        <div class="col-md-6">
                            <div class="form-floating mb-3">
                                <input class="form-control" id="fecha_entrega" name="fecha_entrega" placeholder="fecha_entrega" required readonly></input>
        ...
        xhr.onload = function() {
            if (xhr.status === 200) {
                ...
                actividades.forEach(function(actividad, index) {
                    ...
                    option.text = (index + 1) + '. ' + actividad.odAct_detalle;
                    option.value = actividad.odAct_id;
                    document.getElementById('od_actividades').appendChild(option);
                    console.log(actividad); // Display the response from the AJAX request
                });
            } else {
